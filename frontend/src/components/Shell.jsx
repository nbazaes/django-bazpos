      ...
      <div className="flex h-screen overflow-hidden bg-bg-base text-text-primary font-body antialiased">
        ...
        >
          ...
          <div className="h-[60px] px-4 border-b border-border-default flex items-center justify-between">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-primary-container/20 border border-primary/30 flex items-center justify-center shrink-0 text-primary group-hover:scale-105 transition-transform">
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-bold transition-all duration-150 active:scale-95 ${
                          isActive
                            ? "bg-secondary-container/30 text-primary border border-primary/30 shadow-xs"
                            : link.highlight
                            ? "text-primary hover:bg-surface-variant hover:text-primary font-extrabold"
              ...
              {(!isDesktop || !sidebarCollapsed) ? (
                <>
                  <button
                    ...
                    className="hover:text-primary transition-colors flex items-center gap-1.5 text-[11px] relative"
          ...
          <header className="h-[60px] sticky top-0 z-30 bg-bg-surface/80 backdrop-blur-md border-b border-border-default flex items-center justify-between px-4 sm:px-6 shadow-xs">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                type="button"
                onClick={openChangelog}
                className="relative p-2 rounded-full text-text-secondary hover:text-primary hover:bg-surface-variant transition-colors"
                title="Novedades"
              >
              ...
              <button
                ...
                className="p-2 rounded-full text-text-secondary hover:text-primary hover:bg-surface-variant transition-colors"
              ...
              <div className="flex items-center gap-2 pl-1 sm:pl-2">
                <div className="w-8 h-8 rounded-full bg-secondary-container/40 border border-border-default flex items-center justify-center text-primary font-mono text-xs font-bold">
